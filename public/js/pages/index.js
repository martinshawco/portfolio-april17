...
$(function () {
	...
	if (splashscreen != true) {
		...
		var splashscreenStyleTag = "<style>.splashscreen_container::after{content: '';background-image: url(" + splashscreenPath + splashscreenOptions[Math.floor(Math.random() * splashscreenOptions.length)] + ");background-size: cover;width: 100%; height: 100%;opacity: 0.12;top: 0;left: 0;bottom: 0;right: 0;position: absolute;z-index: 3;}</style>";
